...
- An optional 12-hour **rain-chance forecast** drawn as blue bars around the
  bezel (12 o'clock = soonest hour, clockwise; longer bar = higher chance),
  sourced from the watch's phone-synced weather — no internet permission needed.
...
| Rain Forecast Ticks | Show the next 12 hours of rain chance as blue bezel bars |
